...
pub fn check_interval_and_duration() -> impl Fn(Vec<i64>, i8, u64, i8, u64) -> bool {
    |args: Vec<i64>, a_pitch: i8, a_dur: u64, b_pitch: i8, _b_dur: u64| {
        let interval_time = args[1] as u64;
...
pub fn check_interval_in_range_and_duration() -> impl Fn(Vec<i64>, i8, u64, i8, u64) -> bool {
    |args: Vec<i64>, a_pitch: i8, a_dur: u64, b_pitch: i8, _b_dur: u64| {
        let interval_time = args[3] as u64;
        if a_dur < interval_time || a_pitch == -1 || b_pitch == -1 {
            return false;
        }
        let lower_limit = args[1] as i8;
